...
import com.dhcc.nimiprogram.dao.NpUserDao;
 ...
 */
@Service
public class NpUserServiceImpl extends BaseServiceImpl<NpUserDao, NpUser, String> implements NpUserService {
	@Override
	protected void beforeSave(NpUser object) {
		//新增前
	}
	@Override
	protected void afterSave(NpUser object, NpUser savedObject) {
		//新增后
	}
	@Override
	protected void beforeUpdate(NpUser object) {
		//修改前
	}
	@Override
	protected void afterUpdate(NpUser object, NpUser savedObject) {
		//修改后
	}
	@Override
	protected void beforeDelete(NpUser object) {
		//删除前
	}
	@Override
	protected void afterDelete(NpUser object) {
		//删除后
	}
}
